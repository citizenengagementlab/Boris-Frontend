...
(function() {
  ...
  */
  ...
  submitStartForm = function() {
    var errors, field, i, requiredFields, _i, _j, _len, _len1;
    requiredFields = {
      firstName: {
        id: "#pre_first_name",
  ...
  submitRegistrationForm = function() {
    var data, errors, field, i, requiredBools, requiredFields, _i, _j, _k, _len, _len1, _len2;
    requiredFields = {
      title: {
        id: "#name_title",
    ...
    if (errors.length < 0) {
      ...
      for (_k = 0, _len2 = requiredBools.length; _k < _len2; _k++) {
        i = requiredBools[_k];
