  ...
  return $.ajax({
    ...
    success: function(d) {
      ...
      if (d.state) {
        ...
        return $('span.citystate').text(text);
      } else {
        return $('span.citystate').text(d.error);
      }
    }
  });
};
...
initForm = function() {
  ...
  $("#pre_zip_code, #home_zip_code").on('change', function(e) {
    return updateCityState($(this));
  });
