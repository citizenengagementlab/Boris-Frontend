...
/* -------------------------------------------- 
     Begin accordian-refactor.coffee 
--------------------------------------------
*/
...
initAccordian = function() {
  ...
  $fieldsets.each(function() {
    ...
    if ($fs.parent('fieldset').prev().length !== 0) {
      return $fs.find('li.form-action').prepend("<button class=\"btn-prev\">Back</button>");
    }
  });
  $("button.btn-next").on('click', function(e) {
    e.preventDefault();
